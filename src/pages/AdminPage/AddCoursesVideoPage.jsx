...
function AddCoursesVideoPage() {
  ...
  return (
    <div>
      <AdminNavbar />
      <h1 className="text-xl font-semibold underline p-4 pt-20 text-center">
        Add Courses Video
      </h1>
      <div className="flex justify-center items-center">
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-4">
            {courses.map((course) => (
              <button
                onClick={() => navigate(`/add_courses_video/${course.id}`)}
                key={course.id}
...
export default AddCoursesVideoPage;
